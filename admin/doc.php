                ...
                <div class="col-md-12">
                    ...
                    <table class="table" style="background: #fff;">
                        ...
                        <tbody>
                            ...
                            <a href='images/$id/$profile_pic'>View Image</a>";
                                        } else {
                                            echo "No Image";
                                        }
                                    ?>
                            ...
                            <tr>
                                ...
                                if(!empty($pan_card_img)) {
                                    ...
                                    <a href='images/$id/$pan_card_img'>View Image</a>";
                                } else {
                                    echo "No Image";
                                }
                            ...
                            <a href='images/$id/$aadhar_card_img'>View Image</a>";
                                        } else {
                                            echo "No Image";
                                        }
                            ...
                            <a href='images/$id/$bank_acc_img'>View Image</a>";
                                        } else {
                                            echo "No Image";
                                        }

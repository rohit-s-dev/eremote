...
<head>
    ...
    <body>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 col-md-5">
						<div class="header-socile text-right"> 
		...
		<!-- ===========================
    	=====>> Start Navigation <<===== --> 
		<nav id="topNav" class="navbar navbar-expand-lg navigation  nemu-bg">
			<div class="container nemu-bg">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav ml-auto" id="my-menu2">
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link btns" href="#">App-link </a>
						</li>
						<li class="nav-item">
							<a class="nav-link btns" href="suggestion.php">Suggestion </a>
						</li>
					</ul>
				</div>  
			</div>             
